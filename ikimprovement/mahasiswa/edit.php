      ...
      <div class="row">
        ...
        <form action="update.php" method="post">
            <div class="mb-3">
              ...
              <input type="hidden" class="form-control" id="id" name="id" value= "<?php echo $mahasiswa['id'] ?>">
            </div>
            <div class="mb-3">
              <label for="nim" class="form-label">NIM</label>
              <input type="text" class="form-control" id="nim" name="nim" value= "<?php echo $mahasiswa['nim'] ?>">
            </div>
            <button type="submit"class="btn btn btn-info">Ubah</button>
          </form>
        </div>
      </div>
    </div>
